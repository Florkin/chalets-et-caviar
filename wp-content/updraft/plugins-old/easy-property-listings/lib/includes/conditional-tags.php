...
function epl_get_core_post_types() {
	return apply_filters('epl_core_post_types',array('rural','property','locations','land','commercial','commercial_land','business') );
}
...
/**
 * get list of locations epl posts
 *
 * @since 2.3
 */

function epl_get_core_locations_post_types() {
	return apply_filters('epl_core_locations_post_types',array('locations') );
}
...
/**
 * check if post is locations post
 *
 * @since 2.3
 */
function is_epl_locations_post($type=null) {
	$type = is_null($type) ? get_post_type() : $type;
	return in_array($type,epl_get_core_locations_post_types());
}
