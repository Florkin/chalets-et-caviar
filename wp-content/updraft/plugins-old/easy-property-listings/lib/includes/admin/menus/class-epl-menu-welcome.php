				...
				<div class="feature-section">
					...
					<div class="col">
						...
						<ul>
							...
							<li><?php _e( 'locations', 'easy-property-listings' ); ?></li>
			...
			<div class="changelog headline-feature epl-clearfix">
				...
				<div class="feature-section">
					<div class="col">
						...
						<p><?php _e( 'Doing this allows you to add "Property", "Land" and "locations" pages to your WordPress menu. Add a new page for each listing type you activated.', 'easy-property-listings'  );?></p>

						<p><?php _e( 'For example, lets say you have activated: Property, locations and Land. Create three pages, one called "Property", another "Land" and the third "locations" these will be the custom post type slugs/permalinks eg: property, locations and land.', 'easy-property-listings'  );?></p>
