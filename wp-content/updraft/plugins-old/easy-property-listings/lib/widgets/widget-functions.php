...
function epl_get_price_slider_array($post_type='property',$transaction='default') {
	...
	elseif( is_epl_locations_post($post_type) ) {
		...
		$price_array 	= apply_filters('epl_listing_search_price_slider_locations',$price_array,$post_type,$transaction);
	} else {
...
function epl_get_price_array($post_type='property',$transaction='default') {
	...
	elseif( is_epl_locations_post($post_type) ) {
		...
		// the additional $post_type param passed to apply_filters will enable us to change price range for each post type
		$price_array 	= apply_filters('epl_listing_search_price_locations',$price_array,$post_type,$transaction);
	} else {
...
function epl_get_price_meta_key($post_type='property',$transaction='default') {
	...
	} else if( is_epl_locations_post($post_type) ) {
...
function epl_search_widget_fields_frontend($post_type='',$property_status='',$transaction_type='default') {
	...
	$fields = apply_filters( 'epl_search_widget_fields_frontend',  array(
		...
		array(
			...
			'query'			=>	array('query'	=>	'meta'),
			'class'			=>	'epl-search-row-full',
			'exclude'		=>	array('property','locations','land','commercial','commercial_land','business'),
			'order'			=>	100
		),
		array(
			'key'			=>	'search_house_category',
			...
			'query'			=>	array('query'	=>	'meta'),
			'class'			=>	'epl-search-row-full',
			'exclude'		=>	array('property','locations','rural','commercial','commercial_land','business'),
			'order'			=>	110
		),
		array(
			'key'			=>	'search_house_category',
			...
			'query'			=>	array('query'	=>	'meta'),
			'class'			=>	'epl-search-row-full',
			'exclude'		=>	array('property','locations','land','rural','business'),
			'order'			=>	120
		),
		array(
			'key'			=>	'search_house_category',
			...
			'query'			=>	array('query'	=>	'tax'),
			'class'			=>	'epl-search-row-full',
			'exclude'		=>	array('property','locations','land','rural','commercial','commercial_land'),
			'order'			=>	130
		),
		array(
			'key'			=>	'search_price_global',
