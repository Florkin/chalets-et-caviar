 ...
 * [listing post_type="property,locations" status="current,sold,leased" template="default"] option. You can also
...
function epl_shortcode_listing_callback( $atts ) {
	...
	if ( is_string( $attributes['post_type'] ) && $attributes['post_type'] == 'locations' ) {
