...
/**
 * Function to retrieve property or locations custom fields.
 *
 * @since 1.0
 */
...
// locations / Leased Property Specifics
if ( 'locations' == $post_type ) {
...
if ( 'property' == $post_type || 'locations' == $post_type || 'rural' == $post_type ) {
	//house features
...
} elseif ( 'locations' == $post_type ) {	// locations Pricing
	// locations Meta
