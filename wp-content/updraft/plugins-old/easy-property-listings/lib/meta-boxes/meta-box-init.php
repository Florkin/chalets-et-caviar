...
function epl_get_meta_boxes() {
	...
	$epl_meta_boxes = array(
		...
		array(
			...
			'post_type'	=>	array('property', 'rural', 'locations', 'land', 'commercial', 'commercial_land', 'business'),
			'context'	=>	'normal',
			'priority'	=>	'default',
			'groups'	=>	array(
				array(
				...
				array(
					...
					'fields'	=>	array(
						...
						array(
							...
							'exclude'	=>	array('locations', 'commercial', 'commercial_land')
						),
		...
		array(
			...
			'post_type'	=>	array('property', 'rural', 'locations' ),
			'context'	=>	'normal',
			'priority'	=>	'default',
			'groups'	=>	array(
				array(
					...
					'fields'	=>	array(
						...
						array(
							...
							'include'	=>	array('property', 'locations' )
						),
		...
		array(
			...
			'post_type'	=>	array('property', 'rural', 'locations', 'commercial', 'commercial_land', 'business', 'land','contact_listing'),
			'context'	=>	'side',
			'priority'	=>	'core',
		...
		array(
			...
			'label'		=>	__('locations Pricing', 'easy-property-listings' ),
			'post_type'	=>	array('locations'),
			'context'	=>	'side',
			'priority'	=>	'core',
			'groups'		=>	array(
				array(
					'id'		=>	'locations_pricing',
					'columns'	=>	'1',
					'label'		=>	'',
					'fields'		=>	array(
						...
						array(
							'name'		=>	'property_holiday_locations',
							'label'		=>	__('Holiday locations', 'easy-property-listings' ),
							'type'		=>	'checkbox_single',
							'opts'		=>	array(
								'yes'	=>	__('Yes', 'easy-property-listings' ),
							),
		...
		array(
			...
			'post_type'	=>	array('property', 'rural', 'commercial', 'commercial_land', 'business', 'locations', 'land'),
			'context'	=>	'normal',
			'priority'	=>	'default',
			'groups'		=>	array(
				array(
