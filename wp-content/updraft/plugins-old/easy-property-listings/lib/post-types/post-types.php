...
function epl_custom_restrict_manage_posts() {
	global $post_type;
	if($post_type == 'property' || $post_type == 'locations' || $post_type == 'land' || $post_type == 'commercial' || $post_type == 'rural' || $post_type == 'business' || $post_type == 'holiday_locations' || $post_type == 'commercial_land') {
		...
		if($post_type != 'locations' && $post_type != 'holiday_locations') {
			$fields['sold'] = apply_filters( 'epl_sold_label_status_filter' , __('Sold', 'easy-property-listings' ) );
		}

		if($post_type == 'locations' || $post_type == 'holiday_locations' || $post_type == 'commercial' || $post_type == 'business' || $post_type == 'commercial_land') {
...
$epl_posts = array('property','land', 'commercial', 'business', 'commercial_land' , 'location_profile','locations','rural');
...
function epl_manage_listing_column_price_callback() {
	...
	/* locations Listing Type Custom Values */
